...
//
//  @Mock
//  private RetrofittedVehicleDtoToModelConverter vehicleToLicenceConverter;
//
//  @InjectMocks
...
//    List<RetrofittedVehicleDto> taxiPhvVehicleLicences = mockDataAtS3(bucket, filename, uploaderId);
...
//    given(registerService.register(conversionResults.getRetrofittedVehicles(), uploaderId))
...
//  }
//
//  private ConversionResults mockConversionResult(List<RetrofittedVehicleDto> vehicles) {
//    RetrofittedVehicleDto retrofittedVehicleDto = vehicles.iterator().next();
//    ConversionResults conversionResults = ConversionResults.from(
//        Collections.singletonList(ConversionResult.success(
//            TaxiPhvVehicleLicence.builder()
//                .vrm(retrofittedVehicleDto.getVrm())
//                .licenseDates(
//                    new LicenseDates(
//                        LocalDate.parse(retrofittedVehicleDto.getStart()), LocalDate.parse(
//                        retrofittedVehicleDto.getEnd())
//                    )
//                )
//                .vehicleType(VehicleType.valueOf(retrofittedVehicleDto.getTaxiOrPhv().toUpperCase()))
//                .licensingAuthority(
//                    LicensingAuthority.withNameOnly(retrofittedVehicleDto.getLicensingAuthorityName()))
//                .licensePlateNumber(retrofittedVehicleDto.getLicensePlateNumber())
//                .wheelchairAccessible(retrofittedVehicleDto.getWheelchairAccessibleVehicle())
//                .build()
//            )
//        )
//    );
...
//  }
//
//  private List<RetrofittedVehicleDto> mockDataAtS3(String bucket, String filename, UUID uploaderId) {
//    RetrofittedVehicleDto licence = RetrofittedVehicleDto.builder()
//        .vrm("8839GF")
...
//        .build();
//    List<RetrofittedVehicleDto> licences = Collections.singletonList(licence);
//
//    when(csvRepository.findAll(bucket, filename))
